...
class OpponentShotStateNotifier extends StateNotifier<OpponentShotModel> {
  OpponentShotStateNotifier(
  ...
  void updateDefencePlayer(int? supportPlayerId) {
    state = state.copyWith(
        defencePlayerId: supportPlayerId
    );
  }
    ...
    if (state.result) {
      switch (state.point) {
        case 1:
          ...
          break;
        case 2:
          gameRepository.opponentMadeShot(gameId, RecordType.TWO_POINT_MADE);
          break;
        case 3:
          gameRepository.opponentMadeShot(gameId, RecordType.THREE_POINT_MADE);
          break;
        default:
          break;
      }
      ...
      switch (state.point) {
        case 1:
          ...
          break;
        case 2:
          gameRepository.opponentMissShot(gameId, RecordType.TWO_POINT_MISS);
          break;
        case 3:
          gameRepository.opponentMissShot(gameId, RecordType.THREE_POINT_MISS);
          break;
        default:
          break;
      }
