...
class PbpRepository {
  ...
  List<int> getScoresForChart(int gameId) {
    List<Pbp> q112Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,11,0,0), DateTime(2000,1,1,12,0,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q111Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,10,0,0), DateTime(2000,1,1,10,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q110Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,9,0,0), DateTime(2000,1,1,9,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q19Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,8,0,0), DateTime(2000,1,1,8,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q18Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,7,0,0), DateTime(2000,1,1,7,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q17Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,6,0,0), DateTime(2000,1,1,6,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q16Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,5,0,0), DateTime(2000,1,1,5,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q15Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,4,0,0), DateTime(2000,1,1,4,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q14Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,3,0,0), DateTime(2000,1,1,3,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q13Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,2,0,0), DateTime(2000,1,1,2,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q12Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,1,0,0), DateTime(2000,1,1,1,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q11Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,0,0,0), DateTime(2000,1,1,0,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();

    List<Pbp> q212Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,11,0,0), DateTime(2000,1,1,12,0,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q211Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,10,0,0), DateTime(2000,1,1,10,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q210Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,9,0,0), DateTime(2000,1,1,9,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q29Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,8,0,0), DateTime(2000,1,1,8,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q28Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,7,0,0), DateTime(2000,1,1,7,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q27Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,6,0,0), DateTime(2000,1,1,6,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q26Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,5,0,0), DateTime(2000,1,1,5,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q25Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,4,0,0), DateTime(2000,1,1,4,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q24Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,3,0,0), DateTime(2000,1,1,3,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q23Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,2,0,0), DateTime(2000,1,1,2,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q22Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,1,0,0), DateTime(2000,1,1,1,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q21Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,0,0,0), DateTime(2000,1,1,0,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();

    List<Pbp> q312Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,11,0,0), DateTime(2000,1,1,12,0,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q311Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,10,0,0), DateTime(2000,1,1,10,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q310Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,9,0,0), DateTime(2000,1,1,9,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q39Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,8,0,0), DateTime(2000,1,1,8,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q38Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,7,0,0), DateTime(2000,1,1,7,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q37Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,6,0,0), DateTime(2000,1,1,6,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q36Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,5,0,0), DateTime(2000,1,1,5,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q35Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,4,0,0), DateTime(2000,1,1,4,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q34Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,3,0,0), DateTime(2000,1,1,3,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q33Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,2,0,0), DateTime(2000,1,1,2,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q32Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,1,0,0), DateTime(2000,1,1,1,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q31Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,0,0,0), DateTime(2000,1,1,0,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();

    List<Pbp> q412Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,11,0,0), DateTime(2000,1,1,12,0,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q411Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,10,0,0), DateTime(2000,1,1,10,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q410Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,9,0,0), DateTime(2000,1,1,9,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q49Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,8,0,0), DateTime(2000,1,1,8,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q48Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,7,0,0), DateTime(2000,1,1,7,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q47Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,6,0,0), DateTime(2000,1,1,6,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q46Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,5,0,0), DateTime(2000,1,1,5,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q45Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,4,0,0), DateTime(2000,1,1,4,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q44Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,3,0,0), DateTime(2000,1,1,3,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q43Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,2,0,0), DateTime(2000,1,1,2,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q42Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,1,0,0), DateTime(2000,1,1,1,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q41Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,0,0,0), DateTime(2000,1,1,0,59,0)).and().not().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    ...
    for (var element in q112Pbps) { q1_12 = q1_12 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    for (var element in q111Pbps) { q1_11 = q1_11 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q1_11 = q1_11 + q1_12;
    for (var element in q110Pbps) { q1_10 = q1_10 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q1_10 = q1_10 + q1_11;
    for (var element in q19Pbps) { q1_9 = q1_9 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q1_9 = q1_9 + q1_10;
    for (var element in q18Pbps) { q1_8 = q1_8 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q1_8 = q1_8 + q1_9;
    for (var element in q17Pbps) { q1_7 = q1_7 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q1_7 = q1_7 + q1_8;
    for (var element in q16Pbps) { q1_6 = q1_6 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q1_6 = q1_6 + q1_7;
    for (var element in q15Pbps) { q1_5 = q1_5 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q1_5 = q1_5 + q1_6;
    for (var element in q14Pbps) { q1_4 = q1_4 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q1_4 = q1_4 + q1_5;
    for (var element in q13Pbps) { q1_3 = q1_3 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q1_3 = q1_3 + q1_4;
    for (var element in q12Pbps) { q1_2 = q1_2 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q1_2 = q1_2 + q1_3;
    for (var element in q11Pbps) { q1_1 = q1_1 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q1_1 = q1_1 + q1_2;

    for (var element in q212Pbps) { q2_12 = q2_12 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q2_12 = q2_12 + q1_1;
    for (var element in q211Pbps) { q2_11 = q2_11 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q2_11 = q2_11 + q2_12;
    for (var element in q210Pbps) { q2_10 = q2_10 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q2_10 = q2_10 + q2_11;
    for (var element in q29Pbps) { q2_9 = q2_9 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q2_9 = q2_9 + q2_10;
    for (var element in q28Pbps) { q2_8 = q2_8 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q2_8 = q2_8 + q2_9;
    for (var element in q27Pbps) { q2_7 = q2_7 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q2_7 = q2_7 + q2_8;
    for (var element in q26Pbps) { q2_6 = q2_6 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q2_6 = q2_6 + q2_7;
    for (var element in q25Pbps) { q2_5 = q2_5 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q2_5 = q2_5 + q2_6;
    for (var element in q24Pbps) { q2_4 = q2_4 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q2_4 = q2_4 + q2_5;
    for (var element in q23Pbps) { q2_3 = q2_3 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q2_3 = q2_3 + q2_4;
    for (var element in q22Pbps) { q2_2 = q2_2 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q2_2 = q2_2 + q2_3;
    for (var element in q21Pbps) { q2_1 = q2_1 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q2_1 = q2_1 + q2_2;

    for (var element in q312Pbps) { q3_12 = q3_12 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q3_12 = q3_12 + q2_1;
    for (var element in q311Pbps) { q3_11 = q3_11 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q3_11 = q3_11 + q3_12;
    for (var element in q310Pbps) { q3_10 = q3_10 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q3_10 = q3_10 + q3_11;
    for (var element in q39Pbps) { q3_9 = q3_9 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q3_9 = q3_9 + q3_10;
    for (var element in q38Pbps) { q3_8 = q3_8 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q3_8 = q3_8 + q3_9;
    for (var element in q37Pbps) { q3_7 = q3_7 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q3_7 = q3_7 + q3_8;
    for (var element in q36Pbps) { q3_6 = q3_6 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q3_6 = q3_6 + q3_7;
    for (var element in q35Pbps) { q3_5 = q3_5 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q3_5 = q3_5 + q3_6;
    for (var element in q34Pbps) { q3_4 = q3_4 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q3_4 = q3_4 + q3_5;
    for (var element in q33Pbps) { q3_3 = q3_3 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q3_3 = q3_3 + q3_4;
    for (var element in q32Pbps) { q1_2 = q1_2 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q3_2 = q3_2 + q3_3;
    for (var element in q31Pbps) { q1_1 = q1_1 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q3_1 = q3_1 + q3_2;

    for (var element in q412Pbps) { q4_12 = q4_12 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q4_12 = q4_12 + q3_1;
    for (var element in q411Pbps) { q4_11 = q4_11 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q4_11 = q4_11 + q4_12;
    for (var element in q410Pbps) { q4_10 = q4_10 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q4_10 = q4_10 + q4_11;
    for (var element in q49Pbps) { q4_9 = q4_9 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q4_9 = q4_9 + q4_10;
    for (var element in q48Pbps) { q4_8 = q4_8 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q4_8 = q4_8 + q4_9;
    for (var element in q47Pbps) { q4_7 = q4_7 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q4_7 = q4_7 + q4_8;
    for (var element in q46Pbps) { q4_6 = q4_6 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q4_6 = q4_6 + q4_7;
    for (var element in q45Pbps) { q4_5 = q4_5 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q4_5 = q4_5 + q4_6;
    for (var element in q44Pbps) { q4_4 = q4_4 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q4_4 = q4_4 + q4_5;
    for (var element in q43Pbps) { q4_3 = q4_3 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q4_3 = q4_3 + q4_4;
    for (var element in q42Pbps) { q4_2 = q4_2 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q4_2 = q4_2 + q4_3;
    for (var element in q41Pbps) { q4_1 = q4_1 + (element.shotPosition == null ? 1 : element.shotPosition!.point); }
    q4_1 = q4_1 + q4_2;

    List<int> scores = [
      q1_12, q1_11, q1_10, q1_9, q1_8, q1_7, q1_6, q1_5, q1_4, q1_3, q1_2, q1_1,
      q2_12, q2_11, q2_10, q2_9, q2_8, q2_7, q2_6, q2_5, q2_4, q2_3, q2_2, q2_1,
      q3_12, q3_11, q3_10, q3_9, q3_8, q3_7, q3_6, q3_5, q3_4, q3_3, q3_2, q3_1,
      q4_12, q4_11, q4_10, q4_9, q4_8, q4_7, q4_6, q4_5, q4_4, q4_3, q4_2, q4_1
    ];
  ...
  List<int> getOpponentScoresForChart(int gameId) {
    List<Pbp> q112Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,11,0,0), DateTime(2000,1,1,12,0,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q111Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,10,0,0), DateTime(2000,1,1,10,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q110Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,9,0,0), DateTime(2000,1,1,9,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q19Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,8,0,0), DateTime(2000,1,1,8,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q18Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,7,0,0), DateTime(2000,1,1,7,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q17Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,6,0,0), DateTime(2000,1,1,6,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q16Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,5,0,0), DateTime(2000,1,1,5,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q15Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,4,0,0), DateTime(2000,1,1,4,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q14Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,3,0,0), DateTime(2000,1,1,3,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q13Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,2,0,0), DateTime(2000,1,1,2,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q12Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,1,0,0), DateTime(2000,1,1,1,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q11Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(1).and().playAtBetween(DateTime(2000,1,1,0,0,0), DateTime(2000,1,1,0,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();

    List<Pbp> q212Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,11,0,0), DateTime(2000,1,1,12,0,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q211Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,10,0,0), DateTime(2000,1,1,10,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q210Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,9,0,0), DateTime(2000,1,1,9,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q29Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,8,0,0), DateTime(2000,1,1,8,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q28Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,7,0,0), DateTime(2000,1,1,7,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q27Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,6,0,0), DateTime(2000,1,1,6,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q26Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,5,0,0), DateTime(2000,1,1,5,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q25Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,4,0,0), DateTime(2000,1,1,4,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q24Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,3,0,0), DateTime(2000,1,1,3,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q23Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,2,0,0), DateTime(2000,1,1,2,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q22Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,1,0,0), DateTime(2000,1,1,1,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q21Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(2).and().playAtBetween(DateTime(2000,1,1,0,0,0), DateTime(2000,1,1,0,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();

    List<Pbp> q312Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,11,0,0), DateTime(2000,1,1,12,0,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q311Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,10,0,0), DateTime(2000,1,1,10,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q310Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,9,0,0), DateTime(2000,1,1,9,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q39Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,8,0,0), DateTime(2000,1,1,8,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q38Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,7,0,0), DateTime(2000,1,1,7,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q37Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,6,0,0), DateTime(2000,1,1,6,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q36Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,5,0,0), DateTime(2000,1,1,5,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q35Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,4,0,0), DateTime(2000,1,1,4,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q34Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,3,0,0), DateTime(2000,1,1,3,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q33Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,2,0,0), DateTime(2000,1,1,2,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q32Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,1,0,0), DateTime(2000,1,1,1,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q31Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(3).and().playAtBetween(DateTime(2000,1,1,0,0,0), DateTime(2000,1,1,0,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();

    List<Pbp> q412Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,11,0,0), DateTime(2000,1,1,12,0,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q411Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,10,0,0), DateTime(2000,1,1,10,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q410Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,9,0,0), DateTime(2000,1,1,9,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q49Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,8,0,0), DateTime(2000,1,1,8,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q48Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,7,0,0), DateTime(2000,1,1,7,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q47Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,6,0,0), DateTime(2000,1,1,6,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q46Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,5,0,0), DateTime(2000,1,1,5,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q45Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,4,0,0), DateTime(2000,1,1,4,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q44Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,3,0,0), DateTime(2000,1,1,3,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q43Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,2,0,0), DateTime(2000,1,1,2,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q42Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,1,0,0), DateTime(2000,1,1,1,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
    List<Pbp> q41Pbps = isar.pbps.filter().game((q) => q.idEqualTo(gameId)).and().quarterEqualTo(4).and().playAtBetween(DateTime(2000,1,1,0,0,0), DateTime(2000,1,1,0,59,0)).and().playerIsNull().group((q) => q.typeEqualTo(RecordType.TWO_POINT_MADE).or().typeEqualTo(RecordType.THREE_POINT_MADE).or().typeEqualTo(RecordType.FT_MADE)).findAllSync();
